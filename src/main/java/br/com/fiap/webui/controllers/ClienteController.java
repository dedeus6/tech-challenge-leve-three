...
import br.com.fiap.webui.dtos.response.PaginacaoClienteResponse;
import br.com.fiap.webui.dtos.response.PaginacaoResponse;
import br.com.fiap.app.usecases.ClienteUseCase;
...
import static br.com.fiap.webui.description.Descriptions.LIMIT;
import static br.com.fiap.webui.description.Descriptions.PAGE;
import static br.com.fiap.webui.description.Descriptions.SORT;
import static br.com.fiap.errors.Errors.PAGE_MINIMA;
import static br.com.fiap.errors.Errors.QUERY_PARAMS_REQUERIDO;
...
public class ClienteController {
    ...
    public ResponseEntity<ClienteResponse> cadastrarCliente(@RequestBody @Valid CadastrarClienteRequest request) {
        var response = clienteUseCase.cadastrarCliente(clienteMapper.toClienteDto(request));
    ...
    public ResponseEntity<ClienteResponse> atualizarCliente(
        ...
        return ResponseEntity.ok(clienteUseCase.atualizaCliente(id, clienteDTO));
    }
    ...
    public ResponseEntity<ClienteResponse> buscarClienteById(
            ...
            @PathVariable(name = "id")
            final Long id) {
        return ResponseEntity.ok(clienteUseCase.buscarClienteById(id));
    }
    ...
    public ResponseEntity<ClienteResponse> buscarCliente(
            ...
            final String cpf) {
        return ResponseEntity.ok(clienteUseCase.buscarCliente(cpf));
    }
    ...
    public ResponseEntity<PaginacaoResponse<ClienteResponse>> listarClientes(
            ...
            final String sort) {
        return ResponseEntity.ok(clienteUseCase.listarClientes(page, limit, sort));
    }
}
